...
if __name__=="__main__":
    ...
    while not rospy.is_shutdown():
        ...
        if visualizer.target_received and len(visualizer.targets) >= 3:
            clk *= -1
            msg.data = clk
            ...
            target2_pos_x.append( visualizer.targets[1][0][0] )
            target2_pos_y.append( visualizer.targets[1][0][1] )
            
            target3_pos_x.append( visualizer.targets[2][0][0] )
            target3_pos_y.append( visualizer.targets[2][0][1] )
